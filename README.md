...
基于**Deepseek** 、 **MiMo (小米)**、 **智谱 (Zhipu)**  **Kimi**、**MiniMax** 及 **腾讯混元** 多模型 API的测试用例生成工具，提供图形化界面，可方便地将需求转换为结构化测试用例并导出为Excel格式。。
...
- 🔄 **多 AI 引擎支持** - 一键切换 **Deepseek**、**MiMo (小米)**、**智谱 (Zhipu)** 、**MiniMax** 、 **Kimi** 和 **腾讯混元** 等主流大模型。
...
### 环境要求
- Python 3.10 或更高版本
- 有效的 API Key（支持 Deepseek、MiMo、Zhipu、Kimi、MiniMax 、腾讯混元任选其一或多个）
...
3. **获取API Key**
   ...
   - 腾讯混元 Key：访问 [腾讯混元开放平台](https://hunyuan.cloud.tencent.com/#/app/apiKeyManage)
